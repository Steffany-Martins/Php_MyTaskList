			...
			<div class="row">
				...
				<div class="col-md-9">
					<div class="container pagina">
							...
							<?php foreach($tarefas as $indice => $tarefa) { ?>
								<div class="row mb-3 d-flex align-items-center tarefa">
									...
									<div class="col-sm-3 mt-2 d-flex justify-content-between">
										<i class="fas fa-trash-alt fa-lg text-danger cursor-pointer"  onclick="removerPendente(<?= $tarefa ->id ?>)"></i>
											<i class="fas fa-edit fa-lg text-info cursor-pointer"  onclick="editar(<?= $tarefa ->id ?>, '<?= $tarefa ->tarefa ?>' )"></i>
											<i class="fas fa-check-square fa-lg text-success cursor-pointer"  onclick="marcarRealizadaPendente(<?= $tarefa->id ?>)"></i>
									</div>
								</div>
							<?php } ?>
								</div>
						...
						<p>Você possui <?= count($tarefas) ?> tarefa(s) pendente(s)!</p>
					</div>
				</div>
			</div>
		</div>
